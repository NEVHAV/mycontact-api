    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <div class="header-content-inner">
                    <h1 id="homeHeading">Search contact</h1>
                    <hr>
                </div>
                <form class="form-horizontal" action="http://localhost:8080/contacts/resultSearch" method="post">
                  <div class="form-group">
                      <input type="text" class="form-control" name="search" placeholder="Input name or phonenumber">
                  </div>
